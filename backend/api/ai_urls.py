...
from .views.scam_trends_views import scam_trends_view
from .views.positive_news_views import positive_news_view
...
urlpatterns = [
    ...
    path("scam-trends/", scam_trends_view),
    path("positive-news/", positive_news_view),
